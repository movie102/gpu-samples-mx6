...
/* $Revision: 1.12.12.11 $ on $Date: 2011/06/27 19:06:24 $ */
...
GL_API void GL_APIENTRY glBufferDataARB (GLenum target, GLsizeiptr size, const GLvoid *data, GLenum usage);
GL_API void GL_APIENTRY glBufferSubDataARB (GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data);
